...
const newQuizQuestions = [
  {
    question: "Which of the following best describes a software development methodology?",
    type: "multiple-choice",
    options: [
      "Software methodology is a way to test functions",
      "Software methodology is the process used to create programs",
      "Software methodology is only used in procedural programming",
      "Software methodology is only used for object-oriented programming"
    ],
    answer: 1
  },
  {
    ...
    type: "multiple-choice",
    options: [
      "At the end of every agile cycle a new version of the software is released",
      "Agile repeats SDLC steps",
      "Agile completes the SDLC in sequential order with fixed project requirements",
      "Agile allows for requirements after prototype release"
    ],
    answer: 2
  },
  {
    question: "Which of the following is an imperative programming paradigm type?",
    type: "multiple-choice",
    options: [
      "Mathematical",
      "Logical",
  ...
  {
    question: "Which of the following statements best describes Procedural Programming?",
    type: "multiple-choice",
    options: [
      "All system functions can access the same global variables",
      "Functions are encapsulated with the data",
      "C++ is a procedural programming language",
      "Procedural programming organizes goals into classes"
    ],
    answer: 0
  },
  {
    ...
    type: "multiple-choice",
    options: [
      "Object-oriented programs are better designed",
      "Object-oriented operation definitions are hidden, only behavior is exposed to other classes",
      "Object-oriented class data is available for all system functions",
      "Object-oriented programs can create many objects of the same class"
    ],
    answer: 2
  },
  {
    question: "Which statement best describes software requirement analysis?",
    type: "multiple-choice",
    options: [
      "Requirement analysis is a way to create software architecture",
      "Requirement analysis refines and transforms requirements into user stories",
      "Requirement analysis identifies the classes and their attributes",
      "Requirement analysis is used to create software design"
    ],
    answer: 1
  },
  {
    question: "Why is documentation testing necessary?",
    type: "multiple-choice",
    options: [
      "To have morning coffee with stakeholders",
      "To create the project development schedule",
      "To identify classes in the software",
      "To ensure the correctness of the requirements"
    ],
    answer: 3
  },
  {
    question: "Which of the following is not a step of the requirement analysis process?",
    type: "multiple-choice",
    options: [
      "Create a class diagram",
      "Create a use-case diagram",
      "Map the user stories to a table",
      "Convert requirements to user stories"
    ],
    answer: 0
  },
  {
    question: "Which of the following cannot be an actor in a use-case diagram model?",
    type: "multiple-choice",
    options: [
      "Person",
      "Cash Register",
  ...
  {
    question: "A Sequence Diagram is an example of a...",
    type: "multiple-choice",
    options: [
      "Behavior diagram",
      "Interaction diagram",
