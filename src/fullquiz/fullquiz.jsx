...
import quizData from "./quizData.jsx"; // ✅ Import the full quiz data
import "../weeklycontent/quizpages.css"; // ✅ Import the shared CSS file
...
export default function FullQuiz() {
    ...
    // ✅ Run this only ONCE to shuffle and set questions
    useEffect(() => {
    ...
    return (
        <div className="quiz-container">
            <h1 className="quiz-title">Full Quiz</h1>
